...
function Floors() {
  return (
    <Container style={{marginTop:'30px'}}>
      <Row>
        <Col sm={4} xs={8}>      
        <Card className='blogLeftCards' border="dark" style={{ width: '22rem', boxShadow:'10px 10px 5px 0px rgba(0,0,0,0.75)'}}>
        <Card.Body>
    ...
    <br />
      <Row>
        ...
        <Col sm={4} xs={8}>        
        <Card border="dark" style={{ width: '22rem', boxShadow:'10px 10px 5px 0px rgba(0,0,0,0.75)'}}>
        <Card.Body>
    ...
    <br />
    <br />
    <div className="counterTopDiv">
      <h5>Revamp your floors with Stone Coat Flooring Epoxy Midcoat, a 2:1 ratio epoxy designed for DIYers. Create metallic marble floors with ease, working at your own pace with over 45 minutes of working time. Fill in cracks with Floor Patch Epoxy Gel before applying for a flawless finish. Protect and restore your concrete floors with Moisture Seal Epoxy Primer. </h5>
    </div>
    <br />
    <br />
      <Row>
    ...
    <br />
      ...
      <br />
      <div className='counterTopDiv'>
        <h5>Finish off with Polyaspartic Flooring Topcoat for professional results. Order the complete Stone Coat Countertop Epoxy Flooring System Kit for all the components needed to complete your project. Get started today and turn your dull floors into a statement!</h5>
      </div>
      <br />
      <br />
      <Row>
